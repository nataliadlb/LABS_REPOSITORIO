...
# 2 "<built-in>" 2
# 1 "Librerias y pruebas.c" 2
# 13 "Librerias y pruebas.c"
...
# 53 "Librerias y pruebas.c" 2



uint8_t i, second, minute, hour, m_day, month, year;
# 76 "Librerias y pruebas.c"
void main(void)
{
  OSCCON = 0X70;
  ANSELH = 0;
